...
但是我们可以针对GitHub的这个版本使用或者做二次开发，源码和编译的apk文件在：https://github.com/o0HalfLife0o/TVBoxOSC/releases 截止2025-12-25，该项目**只支持点播不支持直播**，令人感到奇怪。想要**同时支持点播和直播**的，可以下载这个版本：[q215613905/TVBoxOSCRelease](https://github.com/q215613905/TVBoxOSCRelease)，对应的源码项目：[q215613905/TVBoxOS](https://github.com/q215613905/TVBoxOS)

o0HalfLife0o/TVBoxOSC安装后图标是一个黑色的盒子，**小黑盒**。
q215613905/TVBoxOS安装后图标是一个白色的盒子，**小白盒**。
...
## OK影视（推荐）
支持点播和直播。安装后图标是一个彩色的盒子，**小彩盒**。

[OK影视](https://github.com/FongMi/Release) [下载地址](https://github.com/FongMi/Release/tree/okjack/apk/release)
mobile = 手機版
leanback = 電視版
