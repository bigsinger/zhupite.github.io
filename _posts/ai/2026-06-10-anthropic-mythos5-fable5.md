...
description: "Anthropic 发布 Claude Fable 5 和 Claude Mythos 5 两款新一代前沿模型，在软件工程、知识工作、视觉、生命科学等多领域刷新 SOTA。Fable 5 定价仅为 Mythos Preview 的一半，同时引入了新的分类器安全机制——高风险问题自动回退到 Opus 4.8 回答。"
---
