...
![在解决方案下右键菜单-添加-新建项目，搜索C++项目里的“**本机单元测试项目**”](https://docs.microsoft.com/zh-cn/visualstudio/test/media/vs-2019/cpp-new-test-project-vs2019.png?view=vs-2019)
...
![Visual Studio C++测试结果截图](https://docs.microsoft.com/zh-cn/visualstudio/test/media/cpp-google-component.png?view=vs-2019)

![Visual Studio C++测试结果截图](https://docs.microsoft.com/zh-cn/visualstudio/test/media/vs-2019/cpp-gtest-new-project-vs2019.png?view=vs-2019)
...
![- **选择要测试的项目（可选）**：这个勾选要测试的项目名，也可以不选。](https://docs.microsoft.com/zh-cn/visualstudio/test/media/cpp-gtest-config.png?view=vs-2019)
