...
![商业版收款码](../../images/payMethod/commercial.png)
...
![沙箱APP下载](../../images/payMethod/sandboxAppDown.png)



![沙箱APP界面](../../images/payMethod/sandboxApp.png)



使用签名工具创建密钥：

![签名工具生成公钥](../../images/payMethod/signToolGenPublicKey.png)



因为是Android应用，选择PKCS8（JAVA适用），点击生成密钥，复制公钥，然后到沙箱应用中，设置一下这个公钥：

![设置公钥步骤1](../../images/payMethod/setPublicKey1.png)



选择公钥，然后把公钥粘贴进来，最后保存设置。

![设置公钥步骤2](../../images/payMethod/setPublicKey2.png)
...
![沙箱APP界面](../../images/payMethod/sandboxAppUI.png)



![沙箱开始支付](../../images/payMethod/sandboxAppStartPay.png)
...
![沙箱买家账户](../../images/payMethod/sandboxBuyerAccount.png)



继续支付：

![沙箱支付1](../../images/payMethod/sandboxAppPay1.png)

![沙箱支付2](../../images/payMethod/sandboxAppPay2.png)

![沙箱支付3](../../images/payMethod/sandboxAppPay3.png)

![沙箱支付4](../../images/payMethod/sandboxAppPay4.png)
